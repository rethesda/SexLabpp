...
Function EnjoymentSettings()
	...
	AddHeaderOption("Misc Multipliers", enj_header)
	...
	SetCursorPosition(1)
	AddEmptyOption()
	AddStateOptionBool("bUsePhysicBasedDetection", "$SSL_bUsePhysicBasedDetection", enj_flag)
	AddToggleOptionST("GameEnabled", "$SSL_bGameEnabled", Config.GameEnabled, enj_header)

	AddHeaderOption("Game Configs", game_header)
	AddStateOptionBool("bGamePlayerAutoplay", "$SSL_bGamePlayerAutoplay", game_flag)
	AddStateOptionBool("bGamePlayerVictimAutoplay", "$SSL_bGamePlayerVictimAutoplay", game_flag)
	AddStateOptionBool("bGameNPCAutoplay", "$SSL_bGameNPCAutoplay", game_flag)
	AddStateOptionBool("bAllowEdgingReward", "$SSL_bAllowEdgingReward", game_flag)
	AddStateOptionBool("bAllowEdgeSpamPenalty", "$SSL_bAllowEdgeSpamPenalty", game_flag)
